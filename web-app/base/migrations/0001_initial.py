# Generated by Django 4.2.9 on 2024-01-29 21:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default='NULL', help_text='User Name', max_length=64, unique=True)),
                ('phone_num', phonenumber_field.modelfields.PhoneNumberField(default='+19841234567', max_length=128, region=None)),
                ...
                ('vehicle_type', models.CharField(blank=True, choices=[('Economy', 'Economy'), ('Comfort', 'Comfort'), ('Large', 'Large'), ('XL', 'XL')], default='Economy', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_group_num', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ride_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ride_group', to='base.group')),
            ],
        ),
        migrations.AddField(
            model_name='group',
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_order', to='base.ride'),
        ),
        migrations.AddField(
            model_name='group',
            name='sharer',
